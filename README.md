...
And you can download the notebook: [download me and test](https://github.com/PeiHsiuLu/BERTSum_Practice/blob/main/ExtractiveSummarization_RevisedVersion.ipynb) or test on the Colab environment:[Run and test in the Colab] (https://colab.research.google.com/drive/10Jxo7o3B5MibkCfbZ5YVPExczizEVOvJ?usp=sharing)
